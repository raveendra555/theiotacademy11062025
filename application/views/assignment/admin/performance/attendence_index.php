...
<div class="container-fluid mb-5 bg-light border-primary">
    <div class="row bg-light border-dark">
        ...
        <div class="col-md-12 mb-2" id="importfrm" style="display: none;">
            <div><p class="alert alert-warning">All Field Heading name should be like that <b>email, week, week_range, attendance</b></p></div>
            <p class="import__details--text">Import CSV File Of Member Details</p>
            <form action="attendance-csv-report-import" method="post" enctype="multipart/form-data">
        ...
        <table id="member_data" class="table table-striped table-bordered">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th class="text-center">Week Range</th>
                ...
                {   $no_id=1;
                    ...
                    { 
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="text-transform: capitalize;"><?php echo $row['week_label']; ?></td>
