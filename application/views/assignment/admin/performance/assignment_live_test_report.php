...
<header>
    ...
    <div class="container">
        <h4 class="text-white">Assignment/Mini Test/ Live Test Report</h4>
...
<div class="container-fluid mb-5 bg-light border-primary">
    <div class="row bg-light border-dark">
        ...
        <div class="col-md-12 mb-2" id="importfrm" style="display: none;">
            <div><p class="alert alert-warning">All Field Heading name should be like that <b> email,topic_name,date_range,mini_test1,mini_test2,live_test,assignment</b></p></div>
            <p class="import__details--text">Import CSV File Of Member Details</p>
            <form action="assignment-admin-csv-live-test-import" method="post" enctype="multipart/form-data">
        ...
        <table id="member_data" class="table table-striped table-bordered">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th class="text-center">Mini Test 1</th>
                    <th class="text-center">Mini Test 2</th>
