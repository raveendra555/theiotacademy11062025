...
<head>
    <meta charset="utf-8">
    <title>Workshop Certificate Result</title>
...
<header id="myHeader">
    ...
    <div class="container">
        <a class="navbar-brand" href="https://www.theiotacademy.co/adashboard">
            <img class="rounded" width="40" hieght="40" src="<?php echo base_url('assets/images/logo.png')?>">
        </a>
        <a class="navbar-brand" href="workshop-pdf-home"><h4 class="text-white">Certificate Pdf</h4></a>
      ...
      <div class="collapse navbar-collapse" id="main_nav">  
        <ul class="navbar-nav ml-auto text-white">
            <li class="nav-item">
                <a class="nav-link text-white" href="workshop-pdf-home">Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white" href="workshop-pdf-result">Result</a>
            </li>
            <li class="nav-item">
                ...
                { 
                    ...
                    { 
                        ...
                        <tr style="margin-bottom: 5px;">
                            ...
                            <td class="text-center ln_height"><?php echo $row['topic']; ?></td>
                            <td class="text-center ln_height"><a class="btn btn-primary" href="<?php echo base_url().'WorkshopCertificateController/certificatepdfdetails/'. $row['id'] ?>">View</a></td>
                            <td class="text-center ln_height"><a class="btn btn-primary"  href="<?php echo base_url().'WorkshopCertificateController/downloadpdfdetails/'. $row['id'] ?>">Download</a></td>
...
<script type="text/javascript">
 ...
 //=======================Send Mail ===========================               
                $.ajax(
                {
                    url:"<?php echo base_url('pdf-workshop-send');?>",
                    method:"POST",
