...
<head>
    <meta charset="utf-8">
    <title>Workshop Certificate In Pdf Format Home</title>
...
<header>
    ...
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="workshop-pdf-home"><h4 class="text-white">Workshop Certificate</h4></a>
...
<div class="container-fluid my-5 bg-light border-primary">
    <div class="row bg-light border-dark">
        ...
        <div class="col-md-12 mb-2" id="importfrm" style="display: none;">
            <div><p class="alert alert-warning">All Field Heading name should be like that <b>Name Email Topic Collegename Issuedate </b></p></div>
            <p class="import__details--text">Import CSV File Of Workshop User Details</p>
            <form action="workshop-pdf-import" method="post" enctype="multipart/form-data">
                ...
                { 
                    ...
                    { 
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?php echo $row['topic']; ?></td>
