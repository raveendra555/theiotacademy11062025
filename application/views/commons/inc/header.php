        ...
        <div class="nsh-ach-inner">
            ...
            <div class="nsh-ach-right sorttermcoursetb d-none">
                <div style="width: 100%; display: flex; flex-wrap: wrap; gap: 1rem;">
                    ...
                    <a href="https://www.upskillcampus.com/internships" target="_blank" rel="nofollow">
                        <img decoding="async" loading="lazy" src="https://www.theiotacademy.co/assets/dit/images/navbar/upskill.webp" alt="upskill icon" class="img-fluid">
                        <span class="content">
                    ...
                    <a href="https://www.theiotacademy.co/summer-training-program-in-noida">
                        <img decoding="async" loading="lazy" src="https://www.theiotacademy.co/assets/dit/images/navbar/nav-iot.webp" alt="kit" class="img-fluid">
                        <span class="content">
                            <span>AI/Generative AI Programs</span>
                            <span class="duration">4-6 Weeks</span>
                        </span>
                    </a>
                    <a href="https://www.theiotacademy.co/summer-training-program-in-noida" class="custom-btn theam-btn" style="white-space: nowrap; width: auto; height: fit-content; padding: 5px 10px; border-radius: 5px;  margin-top: auto; margin-left: auto; margin-right: auto; justify-content: center;">Explore More</a>
                    -->
                </div>
            </div>
            ...
            <div class="nsh-ach-right management d-none">
                <a href="https://www.theiotacademy.co/embedded-systems-training">
                    <img decoding="async" loading="lazy" src="https://www.theiotacademy.co/assets/dit/images/navbar/nav-iot.webp" alt="kit" class="img-fluid">
                    <span class="content">
                        <span>Embedded Systems Course In Noida By The IoT Academy</span>
                ...
                <a href="https://www.theiotacademy.co/iot-training">
                    ...
                    <span class="content">
                        <span>Internet Of Things Course In Noida By The IoT Academy</span>
                        <span class="duration">1.5/3/6 months</span>
                    </span>
                </a>
            </div>
...
<div class="zeynep" id="zeynep2">
        ...
        <ul>
            ...
            <li class="has-submenu">
                <a href="#" data-submenu="engineering2">Embedded Systems and IoT <span class="badge badge-danger">Guaranteed Placement</span></a>
                            ...
                            <a href="https://www.theiotacademy.co/embedded-systems-training">
                                <div class=" box-hover-effect">
                                    <div>
                                        ...
                                        <p>Embedded Systems Course In Noida By The IoT Academy</p>
                                    </div>
                                </div>
                            </a>
                        </li>
...
<div class="top-strip2" id="StripDiv2">
    <div class="container-fluid">
        ...
        <!--
        <button class="close" type="button" aria-label="close" onclick="document.getElementById('StripDiv2').style.display = 'none'">
