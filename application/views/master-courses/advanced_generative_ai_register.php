...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Application form - Advanced Generative AI Leadership Program</title>
    ...
    <link href="<?=asset_url()?>dit/css/advanced-gen-ai-apply-now.css" rel="stylesheet">
    <!--bootstrap links-->
...
<section class="banner">
    <div class="heaer-section-gorup-dv">
        <div class="container-fluid">
            <div class="header-image-logo-dv">
                <img src="<?=asset_url()?>dit/images/advanced-generative-ai/icon/logo-of-header1.svg" alt="logo 1" class="img-fluid" width="159" height="69">
                <img src="<?=asset_url()?>dit/images/advanced-generative-ai/icon/logo-of-header2.png" alt="logo 2" class="img-fluid" width="132" height="69">
            </div>
        </div>
    </div>
    <div class="container-fluid">
        <h1 class="registration-form-cnt">Registration Form</h1>
        <p class="apply-course-content">Apply for Advanced Generative AI Leadership Program</p>
        <div class="row justify-content-center gy-4">
            ...
            <form method="post" id="SubmitMlRegistrationForm" onsubmit="return false">
                ...
                <input type="hidden" name="came_from_course" value="Apply Now - Advanced Generative AI Leadership Program">
                    <div class="part">
                        ...
                        <div class="form-group">
                            <input type="tel" name="mobile" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" minlength="8" maxlength="10" class="form-control" id="mobile" placeholder="Enter Your Mobile Number*">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="part">
                        ...
                        <div class="form-group">
                            <select name="industry" id="experience" class="form-select">
                    ...
                    <div class="part">
                        <div class="head">Why do you want to learn Advanced Generative AI Leadership Program?
                        (Optional)</div>
                        <div class="form-group">
                            <textarea name="statement" class="form-control" id="statement" style="resize: none; height:120px;" placeholder="Writing a statement of purpose and increase your chances of selection to the
course (maximum 5000 characters)"></textarea>
                        </div>
                    </div>
            ...
            <div class="col-lg-5 col-md-8">
                <div class="right-part">
                    <div class="eict-log-right-dv">
                        <img src="<?=asset_url()?>dit/images/advanced-generative-ai/icon/eict-logo-for-right.png" alt="logo eict" class="img-fluid" width="327" height="57">
                    </div>
                    <h2 class="head">Advanced Generative AI Leadership Program</h2>
                    <p class="tagline">Registration Deadline: <span><?php $this->load->view('course-deadline-date/advanced_gen_ai_last_date');?></span></p>
                    <p class="avalilable-no-seats">(only 8 seats left)</p>
                    <p class="tagline next-batch-parag">Next Batch Start: <span><?php $this->load->view('course-deadline-date/advanced_gen_ai_last_date');?></span></p>
                    <div class="contact-us-rignt">Contact Us.</div>
                    <ul>
                        <li> <span>Call us at</span> <a href="tel:+919354068856"> +91-9354068856</a> or</li>
                        <li> <span>Mail at</span> <a href="mailto:info.eict@theiotacademy.co"> info.eict@theiotacademy.co</a></li>
                        <li> <span>in case of any queries</span></li>
                    </ul>
                </div>
            </div>
        </div>
...
<footer>
    <div class="container-fluid">
        <p>© 2013 - 2025 <a href="https://www.theiotacademy.co/" class="a-underline">The IoT Academy</a>. All Rights Reserved, The EdTech Entity of <a href="https://www.uniconvergetech.in/" class="a-underline">UniConverge Technologies Pvt. Ltd</a></p>
    </div>
</footer>
...
<!--footer nhi aayega-->
    ...
    const formUrl = '<?=base_url()?>Mlwithiotregistration/advanced_genai_registration_submit_form';
