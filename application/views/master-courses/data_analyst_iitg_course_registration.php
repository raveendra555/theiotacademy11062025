...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Application form - Data Analyst IIT Guwahati Course</title>
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center gy-4">
            <div class="col-lg-7 col-md-12">
                ...
                <input type="hidden" name="came_from_course" value="Data Analyst IIT Guwahati Course">
                    <div class="part">
                    ...
                    <div class="part">
                        ...
                        <div class="form-group">
                            <label for="exampleInputstatement">Why do you want to learn Data Analyst IIT Guwahati Course? (Optional)</label>
            ...
            <div class="col-lg-5 col-md-8">
                <div class="right-part">
                    <h2 class="head">Data Analyst IIT Guwahati Course</h2>
